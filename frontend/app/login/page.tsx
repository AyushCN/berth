...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen text-gray-100 overflow-hidden flex items-center justify-center selection:bg-cyan-900/50">
      {/* Dynamic Background */}
            ...
            <div className="backdrop-blur-xl bg-gray-950/40 border border-white/5 rounded-3xl p-10 shadow-[0_0_80px_rgba(14,165,233,0.1)] relative overflow-hidden group">
              ...
              <div className="space-y-4 relative z-10">
                ...
                <motion.button
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-white/5 text-gray-100 font-semibold py-3.5 rounded-xl border border-white/10 hover:bg-white/10 transition-colors"
                >
